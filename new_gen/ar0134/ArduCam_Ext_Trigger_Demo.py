...
def showHelp():
    print " usage: sudo python ArduCam_Py_Single_Demo.py <path/config-file-name>	\
        \n\n example: sudo python ArduCam_Py_Single_Demo.py ../JSON_Config_Files/AR0134_960p_Color.yml	\
        \n\n"
