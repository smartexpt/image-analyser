...
ap.add_argument("-i","--type",choices=["jpg", "png","bmp"],default='jpg',required = False, help = "type to the image file")
ap.add_argument("-c","--capture",action="store_true", help = "Take a picture")
ap.add_argument("-s","--show",action="store_true", help = "Display pictures when taking pictures")
ap.add_argument("-n","--name",required = False, help = "Save the name of the picture")
